        ...
        <div class="row col-12">
            ...
            <div class="row">
                <div class="col-10">
                    <div class="row">
                        <div class="col-2">
                            <input @change="ConsultarPatrocinadoresNuevamente" v-model="CheckboxMostrarTodo" type="checkbox"
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <button @click="getPatrocinadoresPorRangoFecha" class="btn btn-primary">Buscar</button>
