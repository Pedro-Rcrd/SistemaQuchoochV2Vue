        ...
        <div class="row align-items-center" style="margin-top: -4px">
          <div class="divimg mt-1 contenedor-card" style="width: 18rem">
            <img
              class="card-img-top"
              style="height: 10rem"
              src="../../../public/informe.png"
              alt="Card image cap"
            />
          </div>
        </div>
        <h5 class="card-title text-color-card">Lista de compras</h5>
        <RouterLink :to="{ name: 'purchases' }" class="no-underline btn bg-boton"
          >Ver</RouterLink
        >
      </div>
    </div>
