        ...
        <div class="row align-items-center" style="margin-top: -4px">
          <div class="divimg mt-1 contenedor-card" style="width: 18rem">
            <img
              class="card-img-top"
              style="height: 10rem"
              src="../../../public/graduacion.png"
              alt="Card image cap"
            />
          </div>
        </div>

        <h5 class="card-title text-color-card">Becarios por años</h5>
        <RouterLink
          :to="{ name: 'cantidadEstudiantes' }"
        ...
        <div class="row align-items-center" style="margin-top: -4px">
          <div class="divimg mt-1 contenedor-card" style="width: 18rem">
            <img
              class="card-img-top"
              style="height: 10rem"
              src="../../../public/compras.png"
              alt="Card image cap"
            />
          </div>
        </div>
        <h5 class="card-title text-color-card">Gastos y compras activos</h5>
        <RouterLink :to="{ name: 'graphicexpense' }" class="no-underline btn bg-boton"
          >Ver</RouterLink
        >
      </div>
