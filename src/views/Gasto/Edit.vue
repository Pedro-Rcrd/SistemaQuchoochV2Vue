            ...
            <div class="card border border-success mt-3">
                <div class="card-body">
                    <form enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <label for="exampleFormControlInput1" class="form-label">Tipo de pago<span
                                        class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">
                            ...
                            <div class="col-md-4">
                                <label for="exampleFormControlInput1" class="form-label">Número del cheque<span
                                        class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">
                            ...
                            <div class="col-md-4">
                                <label for="exampleFormControlInput1" class="form-label">Monto otorgado<span
                                        class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">
                                        <i class="fa-solid fa-hashtag"></i>
                                            ...
                                            <tr v-for="(producto, index) in listaProductos" :key="index">
                                                ...
                                                <td class="text-center">
                                                    <i data-bs-toggle="modal" data-bs-target="#modalProducto"
                                                        @click.prevent="editarProducto(producto.nombreProducto, producto.cantidad, producto.precio, producto.codigoGastoDetalle)"
                                                        class="fa-solid fa-edit mr-1"></i>
                                                    <i @click.prevent="confirmarEliminarProducto(producto.nombreProducto, producto.codigoGastoDetalle)"
    ...
    if (formActualizarProducto.value.nombreProducto && formActualizarProducto.value.cantidad && formActualizarProducto.value.precio !== "") {
        if (opcion == 1) {
            try {
                ...
                const response = await axios.put(`/api/gasto/actualizarProducto/${codigoProductoActualizar.value}`, formActualizarProducto.value);
                mostrarLoading.value = false;
