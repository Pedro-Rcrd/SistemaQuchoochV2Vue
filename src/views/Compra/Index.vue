    ...
    <div class="row justify-content-center">
        <div class="row col-12">
            ...
            <div class="row justify-content-between ">
                ...
                <div class="col-2">
                    <input v-model="mostrarTodasLasCompras" type="checkbox" class="form-check-input"
                        id="checkRegistro">
                ...
                <div class="col-2">
                    <div class="text-end">
                        <router-link :to="{ path: '/createpurchase' }" class="btn btn-primary mb-3" v-if="authStore.crearModCompra" >
            ...
            <v-card>
                <v-data-table density="compact" :items="resultadoFiltrado" :headers="headers">
                    <template v-slot:item.actions="{ item }">
                        ...
                        <v-icon size="small" v-if="authStore.modificarModCompra">
                            <router-link :to="{ path: '/editpurchase/' + item.codigoCompra }">
