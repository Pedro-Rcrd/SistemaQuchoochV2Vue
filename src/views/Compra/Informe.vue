        ...
        <div class="row col-12">
            ...
            <div class="row">
                <div class="col-10">
                    <div class="row">
                        <div class="col-2">
                            <input @change="ConsultarComprasNuevamente" v-model="CheckboxMostrarTodo" type="checkbox"
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <button @click="getComprasPorRangoFecha" class="btn btn-primary">Buscar</button>
            ...
            <div class="row justify-content-between ">
                <div class="col-8">
                    <input class="form-control" autofocus id="codigoFichaCalificacion" v-model="filtro"
                        @input="buscarCompras" type="text" :placeholder="tipoBusqueda">
                </div>
                <div class="col-2">
                ...
                <div class="col-2">
                    <input v-model="mostrarTodasLasCompras" type="checkbox" class="form-check-input" id="checkRegistro">
                    <label class="form-check-label" for="flexCheckDefault">
                        Mostrar A/F
                    </label>
                </div>
...
const getCompras = async () => {
    try {
        ...
        comprasActivas.value = compras.value.filter(a => a.estado.trim().toUpperCase() === "A");
...
const descargarPDF = async (datos) => {
    ...
    // Datos de la tabla
    const data = datos.map((compra, index) => [index + 1,
