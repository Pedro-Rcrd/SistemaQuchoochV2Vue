    ...
    <div class="row col-12">
      ...
      <div class="row">
        <div class="col-10">
          <div class="row">
            <div class="col-2">
              <input @change="ConsultarEstudiantesNuevamente" v-model="CheckboxMostrarTodo" type="checkbox"
          ...
          <div class="row mt-1">
            ...
            <div class="col-md-4">
              ...
              <div class="input-group mb-3">
                ...
                <input autofocus id="fechaRegistro" required type="date" v-model="formRangoFecha.fechaIncio"
                  class="form-control">
              </div>
            </div>
            ...
            <div class="col-md-4">
              ...
              <div class="input-group mb-3">
                ...
                <input autofocus id="fechaRegistro" required type="date" v-model="formRangoFecha.fechaFin"
                  class="form-control">
              </div>
            </div>
            <div class="col-md-4">
              ...
              <div class="input-group">
                <button @click="getEstudiantesPorRangoFecha" class="btn btn-primary">Buscar</button>
