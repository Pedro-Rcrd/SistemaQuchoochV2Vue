                    ...
                    <tbody class="table-group-divider">
                        <tr v-for="es, i in estudiantes" :key="es.codigoEstudiante">
                            ...
                            <td class="text-center">
                                <router-link :to="{ path: 'informationstudent/' + es.codigoEstudiante }" class="btn btn-secondary active btn-sm">
                                    <i class="fa-solid fa-eye"></i>
                                </router-link>
                            </td>
                            
                            <td class="text-center">
                                <router-link :to="{ path: 'editstudent/' + es.codigoEstudiante }" class="btn btn-warning btn-sm">
        ...
        <div class="modal-body">
            <form @submit.prevent="save">
                ...
                <div class="input-group mb-3">
                    ...
                    <input autofocus type="text" v-model="form.nombreNivelAcademico" placeholder="Nivel Academico" required
