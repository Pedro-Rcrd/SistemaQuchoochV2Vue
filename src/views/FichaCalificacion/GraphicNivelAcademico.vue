        ...
        <div class="row col-11">
            ...
            <div class="container text-center mb-4 ">
                <div class="row row-cols-auto">
                    <div class="col">
                        <router-link :to="{ path: '/graphicsmenu' }">
                            Menú de reportes
                        </router-link>
                    </div>>
                    <div class="col">
                        ...
                        <div class="row justify-content-center"  v-show="ocultarElementos">
                            <div class="col-md-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input placeholder="Año" v-model="anioIngresado" autofocus id="anio" required
                                        type="number" class="form-control text-center fs-5 fw-bold">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <button @click="buscarEstudiantesPorNivelAcademico"
                        ...
                        <div class="col-12 p-0 ">
                            <div class="bg-light p-2" v-show="mostraGraficas">
                                <div class="row justify-content-between">
                                    <div class="col-10">
                                        <h5>Gráfica de estudiantes por niveles académicos del año {{ anioIngresado }}</h5>
                                    </div>
                                    <div class="col-2 pl-5 text-end">
                                        <i @click="exportarPDF" style="font-size: 24px;" v-show="ocultarElementos"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 p-0">
                            <div class="bg-light p-2" v-show="mostraGraficas">
                                <div class="row justify-content-between">
                                    <div class="col-10">
                                        <h5>Gráfica de estudiantes por niveles académicos del año {{ anioIngresado - 1 }}</h5>
                                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-10 ">
                                        <Line v-if="loadedAnioAnterior" :data="chartDataAnioAnterior"
                                    ...
                                    <div class="col-md-10 mb-1">
                                        <div class="table-container">
                                            <table class="table table-scroll table-sm table-striped">
                                                ...
                                                <tbody>
                                                    <tr v-for="(item, index) in cantidadEstudiantesAnioAnterior"
                                                        :key="index">
                                                        <th scope="row" class="text-center">{{ index + 1 }}</th>
                                                        <td class="text-start">{{ item.nivelAcademico }}</td>
                                                        <td class="text-center">{{ item.cantidad }}</td>
...
const getEstudiantesPorNivelAcademico = async () => {
    ...
    const info = await axios.get(`/api/fichaCalificacion/estudiantesPorNivelAcademico/${anioIngresado.value}`)
    cantidadEstudiantes.value = info.data;
    info.data.map((row) => (
        tipos.value.push(row.nivelAcademico),
...
const getEstudiantesPorNivelAcademicoAnioAnterior = async () => {
    const info = await axios.get(`/api/fichaCalificacion/estudiantesPorNivelAcademico/${anioIngresado.value - 1}`)
