        ...
        <div class="row col-11">
            ...
            <div class="container text-center mb-4">
                <div class="row row-cols-auto">
                    ...
                    >
                    <div class="col">
                        <router-link :to="{ path: '/historial' }"> Historial </router-link>
                    </div>
                    >
                    <div class="col">
                            ...
                            <div class="bg-light p-2">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-1 text-end">
                                        <i @click="exportarExcel" style="font-size: 24px"
                                            class="fas fa-file-excel mr-1 text-success" v-show="ocultarElementos"></i>
                    ...
                    <div class="row">
                        <div class="col-12 p-0">
                            <div class="bg-light p-2">
                                ...
                                <div class="row justify-content-between">
                                    <div class="col-11">
                                        <h5>Sección de fotografías <i v-show="ocultarElementos"
                                                @click="getImagenesFicha" class="fas fa-eye"></i></h5>
                                    </div>
                                    <div class="col-1 text-end">
                                        <i @click="exportarImagenesPDF" style="font-size: 24px;"
                                            v-show="ocultarElementos" class="fas fa-circle-down"></i>
                                    </div>
                                </div>
                                ...
                                <div class="row " v-for="item in imagenesFichaEscolar" v-if="imagenesFichaEscolar">
                                    <div class="card m-2 p-2" style="width: 10rem">
                                        <img style="max-width: 150px; max-height: 150px;" :src="item.imgEstudiante"
                                            class="card-img-top" alt="Imagen del estudiante" />
                                        <div class="card-body ">
                                            <div class="row text-end">
                                                <div class="col-12 text-end">
                                                    <i v-show="ocultarElementos"
                                                        @click="abrirImagenEnNuevaVentana(item.imgEstudiante)"
                                    ...
                                    <div class="card m-2 p-2" style="width: 10rem"
                                        ...
                                        <img style="max-width: 150px; max-height: 150px;"
                                            :src="item.imgFichaCalificacion" class="card-img-top"
                                            alt="Imagen de la ficha escolar" />
                                        <div class="card-body">
                                            <div class="row text-end">
                                                <div class="col-12 text-end">
                                                    <i v-show="ocultarElementos"
                                                        @click="abrirImagenEnNuevaVentana(item.imgFichaCalificacion)"
                                                        class="fas fa-circle-plus text-primary"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!--otra tarjeta-->
                                    <div class="card m-2 p-2" style="width: 10rem"
                                        v-if="item.imgCarta && item.imgCarta.length > 60">
                                        <img style="max-width: 150px; max-height: 150px;" :src="item.imgCarta"
                                            class="card-img-top" alt="Imagen de la carta" />
                                        <div class="card-body">
                                            <div class="row text-end">
                                                <div class="col-12 text-end">
                                                    <i v-show="ocultarElementos"
                                                        @click="abrirImagenEnNuevaVentana(item.imgCarta)"
                                                        class="fas fa-circle-plus text-primary"></i>
                                                </div>
                                            </div>
                                        </div>
