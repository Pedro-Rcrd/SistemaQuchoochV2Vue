<template>
    <div class="row justify-content-center">
        <div class="row col-12">
            ...
            <div class="row justify-content-center ">
                <div class="col-6">
                    <input class="form-control text-center fs-5 fw-bold " autofocus id="codigoFichaCalificacion"
                        v-model="cantidadParaMostrar" type="number" placeholder="Cantidad">
                </div>

                <div class="col-2">
                    <div class="">
                        <button @click="getPromediosGenerales" class="btn btn-primary mb-3"> <i
            ...
            <div class="row justify-content-center text-center mt-3">
                ...
                <div class="col-10">
                    <input class="form-control" autofocus id="codigoFichaCalificacion" v-model="filtro"
                        @input="buscarPromediosEstudiantes" type="text" :placeholder="tipoBusqueda">
                </div>
                <div class="col-2">
...
const getPromediosGenerales = async () => {
    try {
        if(cantidadParaMostrar.value == 0 || !cantidadParaMostrar.value || cantidadParaMostrar.value == ""){
            return Swal.fire({
            title: '¡Campos vacíos!',
        ...
        const response = await axios.get(`/api/FichaCalificacion/promediosGenerales/${cantidadParaMostrar.value}`)
...
const descargarPDF = async (datos) => {
    ...
    // Datos de la tabla
    const data = datos.map((a, index) => [index + 1,
    a.nombreEstudiante,
    a.nivelAcademico,
    a.grado,
    a.promedioGeneral,
